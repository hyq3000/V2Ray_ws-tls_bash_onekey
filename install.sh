...
web_camouflage(){
    ...
    git clone https://github.com/hyq3000/3DCEList.git
    judge "web 站点伪装"
}
v2ray_install(){
...
domain_check(){
    read -p "请输入你的域名信息(eg:www.hyq3000.com):" domain
...
v2ray_conf_add(){
    cd /etc/v2ray
    wget https://raw.githubusercontent.com/hyq3000/V2Ray_ws-tls_bash_onekey/master/tls/config.json -O config.json
modify_port_UUID
judge "V2ray 配置修改"
}
nginx_conf_add(){
